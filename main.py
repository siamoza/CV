...
и прочего не установлено в свойствах интерпретатора PyCharm. Должно быть сухо и чисто, и вся система обновлена.
2. Ставить строго и чётко по инструкции тут https://pyimagesearch.com/2018/08/15/how-to-install-opencv-4-on-ubuntu/
3. В конце в свойствах интерпретатора в PyChqrmнужно указать полный путь к библиотеке cv2.so
(Вы там по инструкции переименовывали длинное название либы в короткое 'cv2.so' - вот к ней и указывайте путь.)
"""
import cv2
